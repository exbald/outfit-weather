...
This command **requires** the project directory as an argument via `/app/generations/outfit-weather`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/app/generations/outfit-weather/prompts/app_spec.txt` and `/app/generations/outfit-weather/prompts/initializer_prompt.md`

If `/app/generations/outfit-weather` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/app/generations/outfit-weather/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/app/generations/outfit-weather/prompts/app_spec.txt`
...
**Output path:** `/app/generations/outfit-weather/prompts/initializer_prompt.md`
...
**Output path:** `/app/generations/outfit-weather/prompts/.spec_status.json`
...
> "Your specification files have been created in `/app/generations/outfit-weather/prompts/`!
>
> **Files created:**
> - `/app/generations/outfit-weather/prompts/app_spec.txt`
> - `/app/generations/outfit-weather/prompts/initializer_prompt.md`
>
