 ...
 * 1. Wind speed threshold detection
 * 2. Windy condition detection for different units
 * 3. Windbreaker emoji addition for windy conditions
...
// 4 m/s = 14.4 km/h (below threshold)
test(
  '4 m/s is not windy',
  !isWindy(4, 'ms'),
  'false',
...
// 7 knots = 12.96 km/h (below threshold)
test(
...
// 9 knots = 16.67 km/h (above threshold)
test(
  '9 knots is windy',
  isWindy(9, 'kn'),
  'true',
...
const calmCoolOutfit = getOutfitWithWeather(coolBucket, 2, 5, 'kmh') // 5 km/h wind
...
const buckets: Array<typeof coolBucket> = ['freezing', 'cold', 'cool', 'mild', 'warm', 'hot']
